      ...
      <S.TextWrapper isMobile={isMobile}>
        <S.TextElementWrapper data-aos="fade">
          <div>
            ...
            <p>
              창업, 아이디어는 떠오르지만 막상 만드는 방법을 몰라, 혹은 함께할
              사람이 없어 묻어두지는 않으셨나요?
            </p>
            <br />
            <p>
              NEXT에서는 1년 동안 운영진들이 자체적으로 구축한 커리큘럼에 따라
              개발을 학습하며 소프트웨어 역량을 기르게 되고,
            </p>
            <p>
              다양한 파트너사와의 협업을 통해 기업가적 마인드셋을 갖출 수
              있습니다.
            </p>
            <br />
            {/* <p>
